...
public class FakeStoneHiddenChestGUIGui extends UnknownianmysteriesModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public FakeStoneHiddenChestGUIGui(UnknownianmysteriesModElements instance) {
		super(instance, 48);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("fake_stone_hidden_chest_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FakeStoneHiddenChestGUIGuiWindow::new));
	}
