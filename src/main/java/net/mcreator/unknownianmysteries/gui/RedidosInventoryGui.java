...
public class RedidosInventoryGui extends UnknownianmysteriesModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public RedidosInventoryGui(UnknownianmysteriesModElements instance) {
		super(instance, 79);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("redidos_inventory"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, RedidosInventoryGuiWindow::new));
	}
