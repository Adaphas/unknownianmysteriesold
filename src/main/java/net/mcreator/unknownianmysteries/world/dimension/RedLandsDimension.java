...
import net.mcreator.unknownianmysteries.item.RedLandsItem;
...
public class RedLandsDimension extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:red_lands_portal")
	public static final CustomPortalBlock portal = null;

	public RedLandsDimension(UnknownianmysteriesModElements instance) {
		super(instance, 82);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(Blocks.RED_TERRACOTTA);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("unknownianmysteries:unknownian_red_biome"))
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("unknownianmysteries:red_lands"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("red_lands_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("red_lands_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("red_lands_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new RedLandsItem().setRegistryName("red_lands"));
	}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("unknownianmysteries:red_lands"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("unknownianmysteries:red_lands")));
				} else {
					entity.func_242279_ag();
