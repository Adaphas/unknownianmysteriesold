...
import net.mcreator.unknownianmysteries.world.dimension.CyanSeaDimension;
...
public class CyanSeaItem extends Item {
	@ObjectHolder("unknownianmysteries:cyan_sea")
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				CyanSeaDimension.portal.portalSpawn(world, pos);
