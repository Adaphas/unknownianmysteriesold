...
import net.mcreator.unknownianmysteries.world.dimension.BlueMoonDimension;
...
public class BlueMoonItem extends Item {
	@ObjectHolder("unknownianmysteries:blue_moon")
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				BlueMoonDimension.portal.portalSpawn(world, pos);
