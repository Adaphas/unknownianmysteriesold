...
import net.mcreator.unknownianmysteries.procedures.UntexturedCubeItIsStruckByLightningProcedure;
import net.mcreator.unknownianmysteries.procedures.UntexturedCubeEntityDiesProcedure;
import net.mcreator.unknownianmysteries.itemgroup.UnknownianMysteriesTabItemGroup;
import net.mcreator.unknownianmysteries.entity.renderer.UntexturedCubeRenderer;
...
public class UntexturedCubeEntity extends UnknownianmysteriesModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("untextured_cube").setRegistryName("untextured_cube");

	public UntexturedCubeEntity(UnknownianmysteriesModElements instance) {
		super(instance, 19);
		FMLJavaModLoadingContext.get().getModEventBus().register(new UntexturedCubeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -7960954, -7960954, new Item.Properties().group(UnknownianMysteriesTabItemGroup.tab))
				.setRegistryName("untextured_cube_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, ZombieVillagerEntity.class, false, false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(UntexturedRealmBlockBlock.block));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.bell.resonate"));
		}
		...
		public void func_241841_a(ServerWorld serverWorld, LightningBoltEntity entityLightningBolt) {
			...
			UntexturedCubeItIsStruckByLightningProcedure.executeProcedure(Stream
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			UntexturedCubeEntityDiesProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			return retval;
