...
import net.mcreator.unknownianmysteries.entity.renderer.UnknownianDroneRenderer;
...
public class UnknownianDroneEntity extends UnknownianmysteriesModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("unknownian_drone").setRegistryName("unknownian_drone");

	public UnknownianDroneEntity(UnknownianmysteriesModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new UnknownianDroneRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(UnknownianMysteriesTabItemGroup.tab))
				.setRegistryName("unknownian_drone_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.49);
			...
			ammma = ammma.createMutableAttribute(Attributes.FLYING_SPEED, 0.49);
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unknownian Drone"));
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new BreakBlockGoal(Blocks.END_PORTAL_FRAME, this, 3, (int) 10));
			this.goalSelector.addGoal(2, new OwnerHurtByTargetGoal(this));
			this.goalSelector.addGoal(3, new OwnerHurtTargetGoal(this));
			this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 10, (float) 10, false));
			this.goalSelector.addGoal(5, new BreedGoal(this, 1));
			this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.fromItems(Blocks.BEACON.asItem()), false));
			...
			this.goalSelector.addGoal(11, new LookAtGoal(this, RedidosEntity.CustomEntity.class, (float) 3));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(UnknownianPowerCoreItem.block));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (Blocks.BEACON.asItem() == stack.getItem())
				return true;
			return false;
		}
