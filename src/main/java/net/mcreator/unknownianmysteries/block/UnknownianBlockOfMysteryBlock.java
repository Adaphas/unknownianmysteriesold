...
public class UnknownianBlockOfMysteryBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:unknownian_block_of_mystery")
	public static final Block block = null;

	public UnknownianBlockOfMysteryBlock(UnknownianmysteriesModElements instance) {
		super(instance, 11);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.HONEY).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(4)
			...
			setRegistryName("unknownian_block_of_mystery");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("unknownianmysteries:unknownian_block_of_mystery_match"),
			...
			event.getRegistry().register(feature.setRegistryName("unknownian_block_of_mystery"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("unknownianmysteries:unknownian_block_of_mystery"),
					configuredFeature);
		}
	}
