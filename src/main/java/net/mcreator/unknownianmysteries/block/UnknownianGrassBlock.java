...
public class UnknownianGrassBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:unknownian_grass")
	public static final Block block = null;

	public UnknownianGrassBlock(UnknownianmysteriesModElements instance) {
		super(instance, 46);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unknownian_grass");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("unknownianmysteries:unknownian_grass_match"),
			...
			event.getRegistry().register(feature.setRegistryName("unknownian_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("unknownianmysteries:unknownian_grass"), configuredFeature);
		}
	}
