...
public class UnknownianMetalOreBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:unknownian_metal_ore")
	public static final Block block = null;

	public UnknownianMetalOreBlock(UnknownianmysteriesModElements instance) {
		super(instance, 13);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unknownian_metal_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("unknownianmysteries:unknownian_metal_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("unknownian_metal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("unknownianmysteries:unknownian_metal_ore"),
					configuredFeature);
		}
	}
